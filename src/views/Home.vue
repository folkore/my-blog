...
.post-item:hover {
  ...
  box-shadow:
    0 20px 60px var(--color-shadow-lg),
...
.dark-theme .post-item:hover .post-tag {
...
.dark-theme .post-item:hover .post-item-arrow {
  background: rgba(var(--color-primary-rgb), 0.25);
